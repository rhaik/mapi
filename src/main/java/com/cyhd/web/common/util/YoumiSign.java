...
public class YoumiSign {
     ...
     */
    public static String getUrlSignature(String query, String dev_server_secret) throws IOException, MalformedURLException {
        try {
     ...
     * @return boolean
     */
    public static boolean checkUrlSignature(String signedQueryUrl, String dev_server_secret) {
        String urlSign = "";
        try {
            String[] params = signedQueryUrl.split("&");
            Map<String, String> map = new HashMap<String, String>();
            for (String each : params) {
                String name = each.split("=")[0];
                String value;
