...
/**
 * 用户登陆ID的加密和解密类，加密后1小时内有效
 */
public class LoginIDEncoder {

	private static final int magic_key = 67932737;

	/**
	 * 一小时有效期，过期后无效
	 */
	static MagicKey mk = new MagicKey(Constants.hour_millis, magic_key);
	...
	public static void main(String args[])throws Exception {
		String key = LoginIDEncoder.encode(75);
		...
		System.out.println(LoginIDEncoder.decode(key));
	}
