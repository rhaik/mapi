...
public class ReentrantSortedValueCache<K,V> extends ReentrantSortedValueMap<K,V> {
	...
	public ReentrantSortedValueCache(int maxCapacity, Comparator<? super V> comparator, boolean naturalPutOrder, boolean outputOrder) {
		this(maxCapacity, comparator, naturalPutOrder, outputOrder, true);
	}
	
	public ReentrantSortedValueCache(int maxCapacity, Comparator<? super V> comparator, boolean naturalPutOrder, boolean outputOrder, boolean truncateLast) {
		super(maxCapacity, 2f/*ensure no resize*/, comparator, naturalPutOrder, outputOrder);
		this.maxCapacity = maxCapacity;
		this.truncateLast = truncateLast;
	}
	
	public ReentrantSortedValueCache(int maxCapacity, Comparator<? super V> comparator, boolean naturalPutOrder, boolean outputOrder, boolean truncateLast, boolean fixedCapacity) {
	...
	public static class Ascending<K, V> extends ReentrantSortedValueCache<K,V> {
	...
	@SuppressWarnings("serial")
	public static class Descending<K, V> extends ReentrantSortedValueCache<K,V> {
