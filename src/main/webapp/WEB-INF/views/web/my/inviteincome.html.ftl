...
<#include "/common/scroll_tab_header.ftl">
<style>
	.ui-tab{background-color:#fff;}
	.ui-page, #fpmxListPageFrist{margin-top:47px;}
	...
	.ui-list-info>h4 {color:#000;width: 120px;overflow: hidden;white-space: nowrap;text-overflow:ellipsis;word-wrap:normal;line-height: 45px;}
...
<div data-role="page" id="fpmxListPageFrist" data-iscroll="enable">
	<div data-role="content">
		<div id="wrapperIndex" class="wrapper" >
			<div id="scrollerIndex" class="scroller">
				...
				<div id="fpmxList" data-role="listview">
...
$(function(){ 
	...
	function first() {
	 	serverURL = "${util.ctx}/api/v1/user/inviteincome?friend_level=1"; //服务器地址 
	  	isDisplayLoad = false;
	...
	function second() {
	 	serverURL = "${util.ctx}/api/v1/user/inviteincome?friend_level=2"; //服务器地址 
	   	isDisplayLoad = false;
	...
	incomeDetail = function(id){
		var url = '${util.ctx}/web/my/inviteincome/' + id;
...
<#include "/common/scroll_tab_footer.ftl">