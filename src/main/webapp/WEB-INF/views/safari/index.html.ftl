...
<div class="income">
    <p><span><img src="${util.static}images/home/balance.png" /></span>余额（元）</p>
...
<div class="me_nav clearfix">
    <li><a href="javascript:;" data-href="/ios/user/home.html"><span><img src="${util.static}images/duobao/ico1.png"></span>个人中心</a></li>
    <li><a href="javascript:;" data-href="/ios/share.html"><span><img src="${util.static}images/home/Index_friends.png"></span>收徒</a></li>
</div>
<div class="tishi clearfix" id="tishi-area">
    <span><img src="${util.static}images/home/tishi.png" /></span>
    <p class="marquee" id="msg-panel"></p>
    <em><img src="${util.static}images/sign/right_h.png" /></em>
</div>
